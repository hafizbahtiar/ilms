...
enum BillboardFormExitChoice { saveAndExit, deleteDraft, exitWithoutSaving }

Future<BillboardFormExitChoice?> showBillboardFormExitSheet(
  ...
  return showAppBottomSheet<BillboardFormExitChoice>(
    context: context,
      ...
      return Column(
        ...
        children: [
          ...
          _ExitActionTile(
            ...
            label: 'Save & exit',
            onTap: () => Navigator.of(context).pop(BillboardFormExitChoice.saveAndExit),
          ),
          if (showDeleteDraft) ...[
            ...
            _ExitActionTile(
              ...
              onTap: () => Navigator.of(context).pop(BillboardFormExitChoice.deleteDraft),
            ),
          ],
          const SizedBox(height: 8),
          _ExitActionTile(
            ...
            onTap: () => Navigator.of(context).pop(BillboardFormExitChoice.exitWithoutSaving),
          ),
        ],
      );
    },
