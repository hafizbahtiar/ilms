...
class BillboardDraftMapper {
  ...
  static final _fieldKeys = <String, String Function(BillboardFormFields)>{
    ...
    'hordingStartDate': (f) => f.hordingStartDate.text,
    'hordingCompleteDate': (f) => f.hordingCompleteDate.text,
  ...
  static final _fieldSetters = <String, void Function(BillboardFormFields, String)>{
    ...
    'hordingStartDate': (f, v) => f.hordingStartDate.text = v,
    'hordingCompleteDate': (f, v) => f.hordingCompleteDate.text = v,
