...
class InvestigationFormTabBar extends StatelessWidget {
  const InvestigationFormTabBar({
    super.key,
          ...
          child: Row(
            children: [
              for (var i = 0; i < investigationFormSections.length; i++) ...[
                ...
                _TabChip(
                  key: tabKeys[i],
                  label: investigationFormSections[i].tabLabel,
                  selected: i == activeIndex,
                  required: investigationFormSections[i].isRequired,
                ...
                TextSpan(
                  ...
                  children: [
                    if (required)
                      TextSpan(
                        text: ' *',
                        style: labelStyle.copyWith(color: colorScheme.error, fontWeight: FontWeight.w700),
                      ),
                  ],
                ),
              ),
